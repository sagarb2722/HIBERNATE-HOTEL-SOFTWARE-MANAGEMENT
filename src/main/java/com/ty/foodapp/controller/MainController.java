				...
				if (user.getPassword().equals(password)) {
					if (user.getRole().equals("Manager")) {
						...
						case 2:
							...
							menu1.setId(sc.nextInt());
							System.out.println("Enter the Menu name to update");
							menu1.setName(sc.next());
							boolean menub1 = true;
							List<FoodItems> list1= new ArrayList<FoodItems>();
							while (menub1) {
								FoodItems items = new FoodItems();
								System.out.println("Enter the item name");
								items.setName(sc.next());
							...
							menu1.setItems(list1);
							MenuDao menuDao1 = new MenuDao();
							menuDao1.updateMenu(menu1);
							break;
